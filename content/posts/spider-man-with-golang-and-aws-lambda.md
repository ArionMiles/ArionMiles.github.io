...
Things were so messed up that even after we managed to clear up disk space, the docker daemon on my VM wouldn't work and I wasn't able to restart the compose app. [Namc](namc.in) helped me clear the disk space and fix my docker daemon.
